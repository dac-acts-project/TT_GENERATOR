...
public class StringPrefixIdGenerator implements IdentifierGenerator {
	...
	@Override
	public Serializable generate(SharedSessionContractImplementor sessionImpl, Object object) throws HibernateException {
